...
const About = (props) => {
    ...
    return (
        ...
        <section className='min-h-screen pb-8' id='about'  style={{backgroundColor: props.webMode === 'light'? 'white': 'rgb(32,32,43)'}}>
            ...
            <div className='about-container mt-8 bg-gray-200 p-3 m-16 rounded-3xl sm:p-1 sm:m-8'>

                <div className='about-section  '>
                    <div className='left ml-24 mt-8 md:ml-60 lg:ml-24'>
                        <img src={picImage} alt='' className=' h-[350px] sm:h-60 sm:w-60  ' />
                    </div>

                    <div className='right p-6 justify-center rounded-xl sm:p-1 ' >
                        <div className='p-8 sm:p-1 sm:w-80' >
                            ...
                            <div className='my-6 text-5xl sm:text-3xl'>
                                <div className='flex mx-3 my-6 sm:mx-1 '>
                                    <i className="fa-brands fa-html5 mx-6 sm:mx-3"></i>
                                    <i className="fa-brands fa-js mx-6 sm:mx-3"></i>
                                    <i className="fa-brands fa-react mx-6 sm:mx-3"></i>
                                    <i className="fa-brands fa-css3-alt mx-6 sm:mx-3"></i>
                                    <i className="fa-brands fa-node mx-6 sm:mx-3"></i>
                                    <i className="fa-brands fa-java mx-6 sm:mx-3"></i>
                                </div>

                                <a href= {Resume} download className='bg-blue-600 text-xl rounded-xl p-3 text-white mx-6 font-semibold hover:bg-blue-500 sm:text-lg'>Download CV</a>
                            </div>
                        </div>
                    </div>
                </div>
